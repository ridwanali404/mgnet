...
class GalleryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('marketplace.admin.gallery', compact('galleries'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if($request->image) {
            if($gallery->image) File::delete(public_path($gallery->image));
        ...
        else $imagePath = $gallery->image;
        $is_updated = $gallery->update(array(
            'name' => $request->name,
            'image' => $imagePath
        ));
    ...
    public function publicGallery()
    {
        ...
        return view('shop.gallery', compact('galleries'));
    }
}
