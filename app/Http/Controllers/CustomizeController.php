...
class CustomizeController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('marketplace.admin.customize', compact('customize'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $is_saved = Customize::create(array(
            'title' => $request->title,
    ...
    public function update(Request $request, $id)
    {
        ...
        if($request->image) {
            if($customize->image) File::delete(public_path($customize->image));
        ...
        else $imagePath = $customize->image;
        $is_updated = $customize->update(array(
            'title' => $request->title,
            'sub_title' => $request->sub_title,
            'text' => $request->text,
            'image' => $imagePath,
