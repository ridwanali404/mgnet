...
class AboutUsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('marketplace.admin.about_us', compact('about_us'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if($request->image) {
            if($about_us->image) File::delete(public_path($about_us->image));
        ...
        else $imagePath = $about_us->image;
        $is_updated = $about_us->update(array(
            'title' => $request->title,
            'sub_title' => $request->sub_title,
            'text' => $request->text,
            'image' => $imagePath,
    ...
    public function publicAboutUs()
    {
        $about_us = AboutUs::first();
        return view('shop.about_us', compact('about_us'));
    }
}
