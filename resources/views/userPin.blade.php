    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h3 class="card-title">Pembelian Pin</h3>
                        <div class="table-responsive">
                            <table id="userPin" class="display nowrap table table-hover table-striped table-bordered"
            ...
            <div class="modal inmodal" id="add" role="dialog" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content animated fadeInDown">
                        <form action="{{ url('userPin') }}" method="POST" onsubmit="add.disabled = true;">
                            @csrf
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="users-add" style="width: 100%;" name="user_id" required></select>
                                </div>
                            </div>
                            <div class="modal-footer">
                                <button type="submit" name="add" class="btn btn-info">Beli</button>
                            </div>
                        </form>
                    </div>
                </div>
