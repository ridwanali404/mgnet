                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group m-b">
                            ...
                            <input type="number" name="nominal" min="0" step="100" class="form-control" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label>Reward</label>
                    ...
                    <div class="form-group mb-0">
                        <input type="checkbox" value="1" name="is_platinum" id="is_platinum">
                        <label for="is_platinum">Hanya Platinum<br><small>Reward hanya dapat diklaim oleh Platinum.</small></label>
                    </div>
                </div>
...
<div class="modal inmodal" id="edit{{ $a->id }}" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content animated fadeInDown">
            <form action="{{ url('reward/'.$a->id) }}" method="POST">
                @csrf
                {{ method_field('PUT') }}
                <div class="modal-body">
                    <h3>Ubah</h3>
                    ...
                    <div class="form-group">
                        ...
                        <div class=" input-group m-b">
                            ...
                            <input type="number" name="nominal" value="{{ $a->nominal }}" min="0" step="100"
                    ...
                    <div class="form-group">
                        <label>Reward</label>
                        <div class="input-group m-b">
                            <input type="text" name="reward" value="{{ $a->reward }}" class="form-control" required>
                        </div>
                    </div>
                    <div class="form-group mb-0">
                        <input type="checkbox" value="1" name="is_platinum" id="is_platinum_{{ $a->id }}" {{ $a->is_platinum ? 'checked' : '' }}>
                        <label for="is_platinum_{{ $a->id }}">Hanya Platinum<br><small>Reward hanya dapat diklaim oleh Platinum.</small></label>
                    </div>
                </div>
                <div class="modal-footer">
