						...
						<td>
							...
							<div class="modal inmodal" id="edit{{ $a->id }}" tabindex="-1" role="dialog"
								...
								<div class="modal-dialog">
									<div class="modal-content animated fadeInDown">
										<form action="{{ url('a/category/'.$a->id) }}" method="POST"
											...
											<div class="modal-body">
												...
												<div class="imageupload panel panel-default">
													<div class="panel-heading clearfix">
														<h3 class="panel-title pull-left">Category Image</h3>
														<div class="btn-group pull-right">
															<button type="button"
...
<div class="modal inmodal" id="add" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content animated fadeInDown">
			<form action="{{ url('a/category') }}" method="POST" enctype="multipart/form-data"
